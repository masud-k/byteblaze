                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center -mx-2 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap bg-gray-100 text-gray-800">
                        <Link
                            ...
                            className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 ${tabindex === 0 ? 'border border-b-0' : 'border-b'} rounded-t-lg border-gray-600 text-gray-900`}>
                        ...
                        <Link
                            ...
                            // to={'Autor'}
                            className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2 ${tabindex === 1 ? 'border border-b-0' : 'border-b'} rounded-t-lg border-gray-600 text-gray-900`}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">

...
const Author = () => {
    ...
    return (
        <div className="flex flex-col justify-center w-full p-6 shadow-md rounded-xl sm:px-12 bg-gray-50 text-gray-800">
            ...
            <div className="space-y-4 text-center divide-y divide-gray-300">
                <div className="my-2 space-y-1">
                    ...
                    <p className="px-5 text-xs sm:text-base text-gray-600">User name:{username}</p>
                </div>
                <div className="flex justify-center pt-2 space-x-4 align-center">
                    <a 
                    target="_blank"
                    href={`https://github.com/${github_username}`} aria-label="GitHub" className="p-2 rounded-md text-gray-800 hover:text-violet-600">
                    ...
                    <a 
                    target="-blank"
                     href={website_url} aria-label="Dribble" className="p-2 rounded-md text-gray-800 hover:text-violet-600">
                    ...
                    aria-label="Twitter" className="p-2 rounded-md text-gray-800 hover:text-violet-600">
                        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
